                      ...
                      {row.status === "Active" ? (
                        <>
                          <IconButton
                            ...
                            color="secondary"
                          >
                            <NavLink to={`/admin/link-coupons/${row.id}`}>
                              <ViewIcon />
                            </NavLink>
                          </IconButton>
                          <IconButton
...
const mapStateToProps = state => ({
  coupons: state.linkCoupon.data,
  meta: state.linkCoupon.meta
});
...
const LinkCouponConnct = injectIntl(
  connect(mapStateToProps, mapDispatchToProps)(Main)
);
class LinkCouponWrapper extends Component {
  componentDidMount() {
...
const LinkCoupons = injectIntl(connect(null, mapDispatchToProps1)(LinkCouponWrapper));
  ...
  return (
    <>
      <div className="kt-subheader__main">
        ...
        <h3 className="kt-subheader__title">LinkCoupons</h3>
        ...
        <span>
          <FormControl className={classes.formControl}>
            ...
            >
              <MenuItem value="invitations">All</MenuItem>
              <MenuItem value="InvitationEmail">Email</MenuItem>
              <MenuItem value="InvitationCode">Code</MenuItem>
            </Select>
          </FormControl>
        </span>
      </div>
...
const mapStateToPropsSub = state => ({
  searchCondition: state.linkCoupon.searchCondition
});
const mapDispatchToPropsSub = {
  $changeConditionValue
};
const SubHeaderLinkCoupons = injectIntl(
  connect(mapStateToPropsSub, mapDispatchToPropsSub)(Sub)
);
export { LinkCoupons, SubHeaderLinkCoupons };
